export const NOTICIA_CARROUSEL_UPDATE_FORM_FIELDS_DEF = [
  {
    key: 'id',
    labelKey: 'NOTICIA_CARROUSEL_UPDATE_FORM_FIELDS_DEF_FIELD_id',
    label: 'ID',
    type: 'hidden',
    controlType: 'hidden'
  },
  ...
  {
    key: 'urlHeader',
    labelKey: 'NOTICIA_CARROUSEL_UPDATE_FORM_FIELDS_DEF_FIELD_urlHeader',
    label: 'URL',
    controlType: 'import_image',
    required: true,
    maxLength: 1000
  },
  {
    ...
    labelKey: 'NOTICIA_CARROUSEL_UPDATE_FORM_FIELDS_DEF_FIELD_linktargetHeader',
    type: 'select',
    controlType: 'select',
    required: true,
    value: 0,
